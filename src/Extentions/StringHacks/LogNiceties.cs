namespace TextureJinn.Extentions.StringHacks
{
    public static class LogNiceties
    {
        ...
        public static string AppendPaddedSep(this string str) {
            return string.Concat(str, m_LineEnding, m_StandardSeperator, m_LineEnding);
        }
        ...
        public static string Append2PadSep(this string str) {
            return string.Concat(str, m_LineEnding, m_LineEnding, m_StandardSeperator, m_LineEnding, m_LineEnding);
        }
        ...
        public static string AppendPstPadSep(this string str) {
            return string.Concat(str, m_StandardSeperator, m_LineEnding);
        }
        ...
        public static string AppendPst2PadSep(this string str) {
            return string.Concat(str, m_StandardSeperator, m_LineEnding, m_LineEnding);
        }
    }
}